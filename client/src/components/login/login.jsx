        ...
        <>
            ...
            <div className="w-full max-w-[720px] p-10 rounded-[2.5rem] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl shadow-slate-200/60 dark:shadow-none transition-all duration-500">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="text-center mb-2"> {/* Normalized margin-bottom */}
                        <Typography variant="h4" className="font-black tracking-tighter dark:text-white" sx={{ fontSize: '2.5rem' }}>
                            FitCoach
                        </Typography>
                        <Typography variant="text-center mb-2" className="text-slate-500 dark:text-slate-400 font-medium mt-1">
                    ...
                    <div className="flex items-center my-2 gap-4  mx-auto"> 
                        ...
                        <Typography variant="body2" className="text-slate-400 font-bold uppercase tracking-widest text-sm">
                            or
                        </Typography>
                        <div className="flex-grow border-t border-slate-200 dark:border-slate-800"></div>
                    </div>
